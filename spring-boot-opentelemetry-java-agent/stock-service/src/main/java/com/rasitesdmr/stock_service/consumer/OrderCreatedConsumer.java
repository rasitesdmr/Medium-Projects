...
public class OrderCreatedConsumer {
    ...
    public void consumerOrderCreatedEvent(@Payload OrderCreatedEvent orderCreatedEvent, Acknowledgment ack){
    ...
    public void consumerOrderCreatedErrorEvent(@Payload OrderCreatedEvent orderCreatedEvent, Acknowledgment ack) {
        stockService.decreaseStockQuantity(orderCreatedEvent);
        ack.acknowledge();
    }
    ...
    public void consumerOrderCreatedDLQEvent(@Payload OrderCreatedEvent orderCreatedEvent, Acknowledgment ack){
